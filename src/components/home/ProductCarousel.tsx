									...
									<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 lg:p-8">
										...
										<div className="relative">
											<img
												src={product.img_url}
												alt={product.name}
												className="w-full h-64 lg:h-100 object-fit rounded-lg shadow-md"
											/>
										...
										<div className="flex flex-col justify-center">
											...
											<button
												...
												className="bg-indigo-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors duration-300 flex items-center justify-center space-x-2 w-full sm:w-auto"
											>
